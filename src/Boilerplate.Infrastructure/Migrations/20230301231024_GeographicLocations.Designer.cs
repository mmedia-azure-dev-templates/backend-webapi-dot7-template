...
namespace Boilerplate.Infrastructure.Migrations
{
    ...
    [Migration("20230301231024_GeographicLocations")]
    partial class GeographicLocations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Boilerplate.Domain.Entities.Contact", b =>
                {
                    ...
                    b.HasIndex(new[] { "Name" }, "Contacts_Name_idx")
                        .HasAnnotation("Npgsql:IndexOperators", new[] { "varchar_pattern_ops" });

                    b.HasIndex(new[] { "Ndocument" }, "Contacts_Ndocument_key")
                        .IsUnique()
                        .HasFilter("[Ndocument] IS NOT NULL");
            ...
            modelBuilder.Entity("Boilerplate.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("GeneratedDate1")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("GeneratedDate2")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("GeneratedHour1")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("PaidUserType")
                        .HasMaxLength(1)
            ...
            modelBuilder.Entity("Boilerplate.Domain.Entities.UserInformation", b =>
                {
                    b.HasOne("Boilerplate.Domain.Entities.User", null)
                        ...
                        .HasForeignKey("Boilerplate.Domain.Entities.UserInformation", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
