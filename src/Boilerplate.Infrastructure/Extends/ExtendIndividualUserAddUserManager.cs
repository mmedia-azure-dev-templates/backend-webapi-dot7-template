...
public class ExtendIndividualUserAddUserManager<TIdentity> : IAddNewUserManager
    where TIdentity : ApplicationUser, new()
{
    ...
    public ExtendIndividualUserAddUserManager(IAuthUsersAdminService authUsersAdmin, IAuthTenantAdminService tenantAdminService,
