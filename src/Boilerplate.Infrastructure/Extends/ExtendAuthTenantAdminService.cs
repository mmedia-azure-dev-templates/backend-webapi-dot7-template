...
/// </summary>
public class ExtendAuthTenantAdminService : IAuthTenantAdminService
{
    ...
    public ExtendAuthTenantAdminService(AuthPermissionsDbContext context,
        ...
        ILogger<ExtendAuthTenantAdminService> logger)
    {
        _context = context;
        _options = options;
