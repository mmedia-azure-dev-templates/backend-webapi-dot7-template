...
/// </summary>
public class ExtendInviteNewUserService : IInviteNewUserService
{
    ...
    public ExtendInviteNewUserService(AuthPermissionsOptions options, AuthPermissionsDbContext context,
